...
@section('content')
    ...
    <section class="hero-section">
     ...
     <section class="how-section bg-body-tertiary">
        <div class="container">
            <div class="text-center">
                <h2 class="section-title">Simples <span class="fw-light">Pasos</span></h2>
            ...
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-center gap-5">
                <a href="{{route('register-host.create')}}" class="btn btn-lg btn-primary d-flex align-items-center">
                    <i class="btn-icon text-white align-middle me-3">
                        ...
                        <path fill="#FFFFFF" d="M9.4,18.1c0,3.3,2.7,6,6.1,6c3.3,0,6-2.7,6-6c0-3.3-2.7-6.1-6-6.1C12.1,12.1,9.4,14.8,9.4,18.1z"/>
                        <path fill="#FFFFFF" d="M33.5,5.6C27.1-0.3,17.5-1.4,10,2.9C9,3.5,9.9,5.1,11,4.5c6.1-3.5,13.8-3.2,19.5,1c5.3,3.8,8.2,10.6,7.2,17.1
                        ...
                        <path fill="#FFFFFF" d="M6.6,8.1c0.8,0,1.5-0.7,1.5-1.5c0-0.8-0.7-1.5-1.5-1.5S5.2,5.8,5.2,6.7C5.2,7.5,5.8,8.1,6.6,8.1z"/>
                        <path fill="#FFFFFF" d="M32.5,14.9c0-2.6-2-4.6-4.6-4.6c-2.6,0-4.6,2.1-4.6,4.6c0,2.5,2.1,4.6,4.6,4.6C30.5,19.5,32.5,17.4,32.5,14.9z"
                            />
                        </svg>
                    </i>
                ...
                <a href="{{route('register-volunteer.create')}}" class="btn btn-lg btn-primary d-flex align-items-center">
                    <i class="btn-icon text-white align-middle me-3">
                        <svg class="w-100 h-auto" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                            width="40px" height="40px" viewBox="0 0 40 40" style="enable-background:new 0 0 40 40;" xml:space="preserve">
                        <path fill="#FFFFFF" d="M27.4,18.8c0-4.1-3.3-7.4-7.3-7.4l0,0c-4.1,0-7.3,3.3-7.3,7.3c0,4.1,3.3,7.3,7.3,7.3
                            C24.1,26,27.4,22.8,27.4,18.8z"/>
                        <path fill="#FFFFFF" d="M33.7,5.4C28.2,0.3,20.1-1.4,13,1.2C12,1.6,10.9,2.1,9.9,2.7c-1,0.6-0.1,2.2,0.9,1.6c3.3-1.9,7.1-2.7,10.9-2.4
                        ...
                        <path fill="#FFFFFF" d="M6.5,8C7.3,8,8,7.3,8,6.5C8,5.7,7.3,5,6.5,5C5.6,5,5,5.7,5,6.5C5,7.3,5.6,8,6.5,8z"/>
                        </svg>
                    </i>
