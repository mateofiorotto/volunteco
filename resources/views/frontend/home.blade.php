...
@section('content')
    ...
    <section class="hero-section hero-home">
        ...
        <div class="hero-content container">
            <h1 class="hero-title">Conectá con la <span class="fw-light">naturaleza</span></h1>
    ...
    <section class="py-5 bg-body-tertiary">
        <div class="container">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card project-card">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text mb-3 small text-muted">{{ Str::limit($project->description, 90) }}</p>
            ...
            <div class="text-center">
                <a href="{{ route('projects') }}"
                   class="btn mx-auto btn-warning">Ver todos</a>
            </div>
        </div>
    </section>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="testimonial-card text-body">
                        ...
                        <div class="testimonial-author">
                            <img src="{{ asset('images/avatars/nedith-faro-sm.jpg') }}"
                                 alt="Camila Rojas"
                ...
                <div class="col-md-4">
                    <div class="testimonial-card text-body">
                        ...
                        <div class="testimonial-author">
                            <img src="{{ asset('images/avatars/fireo.jpg') }}"
                                 alt="Fireo"
                                 class="testimonial-avatar object-fit-contain border-secondary">
                            <div>
                ...
                <div class="col-md-4">
                    <div class="testimonial-card text-body">
                        ...
                        <p class="mb-0">"Mi vida cambió después de este voluntariado. No solo ayudé al medio ambiente,
                            ...
                            propósito."</p>
                        <div class="testimonial-author">
                            <img src="{{ asset('images/avatars/blitzboy.jpg') }}"
                                 alt="Fernando Pérez"
                                 class="testimonial-avatar">
                            <div>
        ...
        <div class="container">
            ...
            <div class="d-md-flex align-items-center justify-content-center gap-5 mb-5">
                <div class="text-center mb-5 mb-lg-0 px-3">
                    <img src="{{ asset('images/sponsors/temaiken-bioparque.svg') }}"
                         alt="Temaiken"
                         width="130"
                         height="130"
                ...
                <div class="text-center mb-lg-0 mb-5 px-3">
                    <img src="{{ asset('images/sponsors/vida.jpg') }}"
                         width="130"
                         height="130"
                ...
                <div class="text-center mb-lg-0 mb-5 px-3">
                    <img src="{{ asset('images/sponsors/logo-azara-color-280.svg') }}"
                         width="130"
                         height="130"
                         alt="fundación azara"
    ...
    @include('partials.banner-donations')
