    ...
    <section class="py-5 my-5">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="section-title text-primary">Últimos <span class="fw-light">Proyectos</span></h2>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div>
                                        <a href="{{ route('project', $project->id) }}" class="btn btn-sm btn-outline-primary">Ver Detalles</a>
                                    </div>
                                </div>
                            </div>
                        </div>
