                                            ...
                                            <div class="row gap-5">
                                                <div class="col">
                                                    <ul class="list-unstyled">
                                                        <li><span class="text-muted small">Anfitrión: </span>{{ $project->host->name }}</li>
                                                        <li><span class="text-muted small">Email: </span><a href="mailto:{{ $project->host->user->email }}" target="_blank">{{ $project->host->user->email }}</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled small mb-0">
                                ...
                                <li><i class="bi bi-geo-alt me-2"></i>{{ $project->host->location->name ?? 'Sin ubicación' }}</li>
                                @endif
                            </ul>
                            <a href="{{ route('admin.hosts.profile', $project->host->user->id) }}" class="btn btn-sm btn-outline-primary mt-3 w-100">
                                ...
                                <li class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-md-3">
                                            ...
                                            <span class="badge {{ $volunteer->pivot->status === 'aceptado' ? 'text-bg-success' : ($volunteer->pivot->status === 'rechazado' ? 'text-bg-danger' : 'text-bg-warning') }}">
