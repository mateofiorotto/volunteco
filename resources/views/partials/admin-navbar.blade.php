...
<div class="collapse navbar-collapse align-items-lg-center"
     id="navbarMenu">
    @auth
            ...
            @if (Auth::user()->hasRole('volunteer'))
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('volunteer.projects.applied') ? 'active' : '' }}"
                       href="{{ route('volunteer.projects.applied') }}">Mis Proyectos</a>
                </li>
            @endif
            <li class="nav-item dropdown dropdown-center">
                @if (Auth::user()->hasRole('volunteer'))
                    <a class="nav-link dropdown-toggle {{ request()->is('usuario/voluntario/mi-perfil*') ? 'active' : '' }}"
                       href="#"
                       role="button"
                       data-bs-toggle="dropdown"
                       aria-expanded="false">
                ...
                @elseif(Auth::user()->hasRole('host'))
                    <a class="nav-link dropdown-toggle {{ request()->is('usuario/anfitrion/mi-perfil*') ? 'active' : '' }}"
                       href="#"
                       role="button"
                       data-bs-toggle="dropdown"
                       aria-expanded="false">
