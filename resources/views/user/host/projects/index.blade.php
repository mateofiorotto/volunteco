        ...
        <div class="projects-list">
            ...
            @else
                ...
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col" class="fw-semibold">Imagen</th>
                    ...
                    @foreach ($projects as $project)
                        <tr class="{{$project->enabled != 1 ? 'table-danger' : ''}}" >
                            <td>
                                <img src="{{ asset('storage/' . ($project->image ?? 'thumbnail-proyecto.jpg')) }}" alt="Imagen del proyecto {{ $project->title }}" class="object-fit-cover" width="80" height="auto">
                            </td>
                            <td>{{ $project->title }}</td>
                            <td>
                                <div>
                            ...
                            <td>
                                <a href="{{ route('host.my-projects.show', $project->id)}}" class="btn btn-sm btn-azul" title="ver">Ver</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
